 ...
 */
package org.exoplatform.cross.demo.portlet;
 ...
 */
@ComponentConfig(lifecycle = UIApplicationLifecycle.class, template = "app:/templates/UIDemoPortlet.gtmpl", events = { @EventConfig(listeners = UIDemoPortlet.OpenPopupActionListener.class) })
